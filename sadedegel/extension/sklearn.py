...
class Text2Doc(BaseEstimator, TransformerMixin):
    ...
    def __init__(self, tokenizer="icu", hashtag=False, mention=False, emoji=False, repetition_correction=False, progress_tracking=True):
    ...
    def init(self):
        if Text2Doc.Doc is None:
            if hasattr(self, 'hashtag') and hasattr(self, 'mention') and hasattr(self, 'emoji') and hasattr(self, 'repetition_correction'):
