...
from .util import normalize_tokenizer_name, character_repetition_correction
...
class WordTokenizer(ABC):
    ...
    def __init__(self, mention=False, hashtag=False, emoji=False, repetition_correction=False):
        """
        ...
        self.emoji = emoji
        self.repetition_correction = repetition_correction
    ...
    def __call__(self, sentence: str) -> List[Token]:
        ...
        if self.repetition_correction:
            text = character_repetition_correction(text)
    ...
    @staticmethod
    def factory(tokenizer_name: str, mention=False, hashtag=False, emoji=False, repetition_correction=False):
        console.log(f"mention={mention}, hashtag={hashtag}, emoji={emoji}, repetition_correction={repetition_correction}")
        ...
        if normalized_name not in WordTokenizer.__instances:
            if normalized_name == "bert":
                return BertTokenizer(mention, hashtag, emoji, repetition_correction)
                ...
                return SimpleTokenizer(mention, hashtag, emoji, repetition_correction)
            elif normalized_name == "icu":
                return ICUTokenizer(mention, hashtag, emoji, repetition_correction)
            else:
                raise Exception(
...
class BertTokenizer(WordTokenizer):
    ...
    def __init__(self, mention=False, hashtag=False, emoji=False, repetition_correction=False):
        super(BertTokenizer, self).__init__(mention, hashtag, emoji, repetition_correction)
...
class SimpleTokenizer(WordTokenizer):
    ...
    def __init__(self, mention=False, hashtag=False, emoji=False, repetition_correction=False):
        super(SimpleTokenizer, self).__init__(mention, hashtag, emoji, repetition_correction)
...
class ICUTokenizer(WordTokenizer):
    ...
    def __init__(self, mention=False, hashtag=False, emoji=False, repetition_correction=False):
        super(ICUTokenizer, self).__init__(mention, hashtag, emoji, repetition_correction)
